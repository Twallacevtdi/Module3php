              ...
              <div class="col-md-3">
                ...
                <div class="select-wrap">
                  ...
                  <select name="parishes" id="select-parish" class="form-control d-block rounded-0">
                    <option value="kingstonk">Kingston</option>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="#" class="service text-center">
              ...
              <p>The residential real estate market is diverse, offering a wide range of options to suit different needs and preferences.</p>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="#" class="service text-center">
              ...
              <p>easures to safeguard physical assets, buildings, and people. </p>
              <p><span class="read-more">Read More</span></p>
            </a>
          </div>
        </div>
